...
TINYMCE_DEFAULT_CONFIG = {
    ...
    # Configurações de colagem
    'paste_preprocess': 'function(plugin, args) { console.log("Paste preprocess"); }',
    'paste_postprocess': 'function(plugin, args) { console.log("Paste postprocess"); }',
